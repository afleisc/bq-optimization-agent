...
This project demonstrates how to run a specialized agent which can help optimize BigQuery queries.
...
1.  **Clone the Repository:**
    ...
    ```bash
    git clone https://github.com/afleisc/bq-optimization-agent.git
...
5.  **BigQuery Setup:**
    ...
    *   First, set the BigQuery project ID in the `.env` file. This can be the same GCP Project you use for `GOOGLE_CLOUD_PROJECT`,
        ...
        export BQ_DATASET_ID='YOUR-DATASET-ID' # leave as 'optimization_workshop' if using default metadata
        ```
